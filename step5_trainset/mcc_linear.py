...
while i<=5:
    ...
    predname=open('set'+str(i)+'.svm0.pred','r').read().splitlines()
...
means = open('mcc_RBF0.txt','r').read().splitlines()
means.append(open('mcc.txt','r').read().splitlines()[0])
means+=open('C:/Users/admin/Desktop/project/step5_trainset/set_6/mcc0.txt','r').read().splitlines()
...
plt.title('MCC of linear kernel')
